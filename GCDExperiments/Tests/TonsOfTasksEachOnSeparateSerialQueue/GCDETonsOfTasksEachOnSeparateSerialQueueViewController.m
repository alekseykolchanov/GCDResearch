//
//  GCDETonsOfTasksOnPrivateConcurrentQueueViewController.m
//  GCDExperiments
//
...
@interface GCDETonsOfTasksEachOnSeparateSerialQueueViewController ()<GCDETonsOfTasksEachOnSeparateSerialQueueTestDelegate>
...
@implementation GCDETonsOfTasksEachOnSeparateSerialQueueViewController
...
- (void)setTest:(GCDETonsOfTasksEachOnSeparateSerialQueueTest *)test {
  _test = test;
  _test.delegate = self;
  [self updateTestUI];
}

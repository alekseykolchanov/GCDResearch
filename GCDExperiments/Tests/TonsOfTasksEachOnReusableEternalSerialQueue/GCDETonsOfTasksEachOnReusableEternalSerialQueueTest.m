...
@implementation GCDETonsOfTasksEachOnReusableEternalSerialQueueTest {
  int _fibonacciN;
  int _numberOfTasks;
...
- (void)startWithQoS:(dispatch_qos_class_t)qos {
  ...
  __weak GCDETonsOfTasksEachOnReusableEternalSerialQueueTest *weakSelf = self;

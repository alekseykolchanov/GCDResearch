//
//  GCDETonsOfTasksEachOnReusableEternalSerialQueueViewController.m
//  GCDExperiments
//
...
@interface GCDETonsOfTasksEachOnReusableEternalSerialQueueViewController ()<GCDETonsOfTasksEachOnReusableEternalSerialQueueTestDelegate>
...
@implementation GCDETonsOfTasksEachOnReusableEternalSerialQueueViewController
...
- (void)setTest:(GCDETonsOfTasksEachOnReusableEternalSerialQueueTest *)test {
  _test = test;
  _test.delegate = self;
  [self updateTestUI];
}
